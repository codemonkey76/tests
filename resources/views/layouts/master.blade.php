...
<head>
    ...
    <title>{{ config('app.name', 'Laravel55') }}</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @else
                        <li class="" style="padding-top: 5px!important;" >
                        @if (Auth::user()->belt == null)
                            <button class="btn btn-primary btn-lg" onclick="window.location='{{ url("SetRank") }}'">Set Rank</button>
                        @else
